                ...
                <div class="row row-cols-lg-4 row-cols-md-2 row-cols-1">
                    <div class="col">
                        ...
                        <div class="footer-widget media-widget mb-4">
                            ...
                            <a href="https://www.instagram.com/dillionpropertyltd" target="_blank"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="col">
        ...
        <div class="copyright bg-footer text-default py-4">
            <div class="container">
                <div class="row row-cols-md-2 row-cols-1">
                    <div class="col">
                        <span class="text-white">© <script>document.write(new Date().getFullYear());</script> Dillion Property LTD. All right reserved || Built by <a href="https://www.webify.com.ng" target="_blank" class="text-danger">Webify </a></span>
                    </div>
                    <div class="col">
