...
function sendVerificationEmail($userEmail, $token, $first_name, $last_name)
{
    global $mailer;
    $body = '<!DOCTYPE html>
    <html>
                 ...
                 <td class=\'pdt-4x pdb-4x\'>
                    ...
                    <table class=\'email-body\' border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                        <div style=\'padding-left: 30px;\'>
                            <tbody>
                                <tr>
                                    <td class=\'pd-3x pdb-1-5x\'><h2 class=\'email-heading\' style="font-family:\'Helvetica\',Helvetica,Arial,sans-serif;color:#151515;font-size:18px;font-weight:700;line-height:34px;letter-spacing:-0.4px;text-align:center">Email Verification</h2></td>
                                </tr>
                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td style="padding:20px" valign="top">
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="font-family:\'Helvetica\',sans-serif;font-size:14px;line-height:20px;letter-spacing:-0.2px;color:#d8d8d8" valign="top">Dillion Property is a premier real estate consulting firm dedicated to providing exceptional service and expertise in the real estate sector.</td>
                                                                                </tr>
                                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="font-family:Arial,sans-serif;font-size:19px" valign="top">
                                                                                        <a href="https://www.facebook.com/dillionpropertyltd" style="text-decoration:none" target="_blank"><img src="https://i.imgur.com/Npic50c.png" width="20" height="20" alt="Facebook" style="border:0;line-height:100%;outline:0;color:#ffffff"></a>
                                                                                        <span>&nbsp;&nbsp;</span>
                                                                                        <a href="https://www.instagram.com/dillionpropertyltd" style="text-decoration:none" target="_blank"><img src="https://i.imgur.com/BA6mxfq.png" width="21" height="20" alt="Instagram" style="border:0;line-height:100%;outline:0;color:#ffffff"></a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="font-family:\'Helvetica\',sans-serif;font-size:18px;font-weight:500;line-height:24px;letter-spacing:-0.2px" valign="top">
                                                                                        <a href="tel:+2348186161570" style="text-decoration:none;color:#ed1c24;font-size:14px" target="_blank">+234 818 616 1570</a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                      ...
                      <tbody>
                        <tr>
                            <td class="" style="padding:40px 30px 32px;background-color:#ed1c24" valign="top" bgcolor="#ed1c24">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                    <tbody>
                                        <tr>
                                            <td style="font-family:\'Helvetica\',Helvetica,Arial,sans-serif;font-size:14px;font-weight:400;line-height:28px;color:#9b9b9b;text-align:center" valign="top"><span style="color:#ffffff"><strong>© 2024 Dillion® All rights reserved.</strong></td>
                                        </tr>
                                        <tr>
